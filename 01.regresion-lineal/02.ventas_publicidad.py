...
def main():
    ...
    # Caso 2: Ventas vs Publicidad
    df2 = pd.read_csv('00.datasets/ventas_publicidad.csv')
    modelo2 = analizar_regresion(
        df2, 'Publicidad', 'Ventas', 
        'Relación Ventas-Publicidad (20 registros)'
    )
