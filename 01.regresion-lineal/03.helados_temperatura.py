...
def main():
    ...
    # Caso 3: Temperatura vs Ventas de Helado
    df3 = pd.read_csv('00.datasets/03.helados_temperatura.csv')
    modelo3 = analizar_regresion(
        df3, 'Temperatura', 'Ventas_Helados', 
        'Relación Temperatura-Ventas Helado (30 registros)'
    )
